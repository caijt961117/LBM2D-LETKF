...
template<> struct mpi::MPItypename<float      > { static constexpr MPI_Datatype name() { return MPI_FLOAT      ; } };
template<> struct mpi::MPItypename<double     > { static constexpr MPI_Datatype name() { return MPI_DOUBLE     ; } };
template<> struct mpi::MPItypename<long double> { static constexpr MPI_Datatype name() { return MPI_LONG_DOUBLE; } };
template<> struct mpi::MPItypename<int        > { static constexpr MPI_Datatype name() { return MPI_INT        ; } };
template<> struct mpi::MPItypename<long       > { static constexpr MPI_Datatype name() { return MPI_LONG       ; } };
template<> struct mpi::MPItypename<long long  > { static constexpr MPI_Datatype name() { return MPI_LONG_LONG  ; } };
